...
This package contains:
   ...
   Magnolia Core 5.2.3
   Magnolia Internationalization Framework 5.2.3
   Magnolia JAAS 5.2.3
   Magnolia Imaging Module 3.0.3
   Magnolia Legacy UI 5.2.2
   magnolia-module-mail 5.1.3
   Magnolia Rendering 5.2.3
   Magnolia Templating 5.2.3
   Magnolia Templating for JSP 5.2.3
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.2.3.html
